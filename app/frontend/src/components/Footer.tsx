        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-300">
              ...
              <div className="flex items-start gap-2">
                ...
                <span>
                  No4 Shamsudeen-amusa Street
                  <br />
                  school-gate,Lakowe. Lagos
                </span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="https://www.facebook.com/share/1B94gzn9Dy/"
                target="_blank"
              ...
              <a
                href="https://www.tiktok.com/@apstleemmanueldavidcraig?is_from_webapp=1&sender_device=pc"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-[#e94560] transition"
              >
              ...
              <a
                href="https://youtube.com/@apostleemmanueldavidcraig?si=lLnoCPds7i14WAGS"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-[#e94560] transition"
              >
